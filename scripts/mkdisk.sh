...
for prog in juice echo uname greetd greet peel clock squeeze grove about files trash ping net fetch bench host-agent host-probe hardware vm-probe simd-probe fault-null fault-ro fault-nx fault-opcode; do
